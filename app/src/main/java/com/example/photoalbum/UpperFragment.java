...
public class UpperFragment extends Fragment {
    ...
    private static final int[] imageSources = {R.drawable.animal13, R.drawable.animal14, R.drawable.animal15, R.drawable.animal16, R.drawable.animal17, R.drawable.animal18};
