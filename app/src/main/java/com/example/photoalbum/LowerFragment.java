...
public class LowerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enableSlideShow = view.findViewById(R.id.enableSlideshow);
        enableSlideShow.setOnClickListener(v -> {
            if (((CompoundButton) (v)).isChecked()) {
                prevBtn.setEnabled(false);
                nextBtn.setEnabled(false);
                ((MainActivity) getActivity()).enableSlideShow();
            } else {
                prevBtn.setEnabled(true);
                nextBtn.setEnabled(true);
                ((MainActivity) getActivity()).disableSlideShow();
            }
        });
